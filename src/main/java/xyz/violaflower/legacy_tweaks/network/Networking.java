...
public class Networking {
	public static void registerNetworkingCodecs() {
		...
		NetworkingAbstractions.registerCodec(CoolConfigurationPacket.TYPE, CoolConfigurationPacket.STREAM_CODEC, NetworkingAbstractions.PayloadType.CONFIGURATION_C2S);
	}
	...
	public static void registerPayloadHandlers() {
		...
		ServerboundConfiguration.registerHandler(CoolConfigurationPacket.TYPE, (payload, context) -> {
	...
	public static void registerConfigurationTasks() {
		ServerConfigurationEvents.registerOnConfigure(new SendCoolConfigurationPacketTask());
	}
}
