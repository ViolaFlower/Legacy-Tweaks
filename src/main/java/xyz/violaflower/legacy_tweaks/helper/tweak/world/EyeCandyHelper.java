package xyz.violaflower.legacy_tweaks.helper.tweak.world;
...
public class EyeCandyHelper {
	...
	enum BiomeColors {
		...
		BAMBOO_JUNGLE_HILLS(0xa51B9ED8, 0x001B9ED8, 0xa575ABFF),
		...
		DEEP_WARM_OCEAN(0xa502B0E5, 0x0002B0E5, 0xa50000c9),
		DESERT(0xa532a598, 0x0044aff5, 0xa56FB2FF),
		WINDSWEPT_HILLS(0xa5007BF7, 0x00007BF7, 0xa57EA3FF),
		MOUNTAIN_EDGE(0xa5045cd5, 0x00045cd5, 0xa57EA3FF),
		WINDSWEPT_GRAVELY_HILLS(0xa50E63AB, 0x000E63AB, 0xa57EA3FF),
