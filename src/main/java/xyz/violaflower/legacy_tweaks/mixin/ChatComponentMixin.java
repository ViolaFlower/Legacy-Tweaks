...
public class ChatComponentMixin {
    ...
    Object gydsfuiysdivkksyoi(OptionInstance instance, Operation<Object> original) {
        if (!TweakManager.getInstance().getTweak("Legacy Chat").isEnabled()) return original.call(instance);
        return TweakManager.getInstance().<FatChat>getTweak("Legacy Chat").getLineHeight();
    }
