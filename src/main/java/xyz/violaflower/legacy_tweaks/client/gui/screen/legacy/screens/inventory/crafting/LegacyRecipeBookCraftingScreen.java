...
//            System.out.println("Rendered " + recipeBookTabButton + " at " + recipeBookTabButton.getX() + "," + recipeBookTabButton.getY());
...
//                    extension.lt$setVisualX(k + 128f);
//                    extension.lt$setVisualY(k + 145.45f);
//                    extension.lt$setSize(32);
//                } else {
//                    // yes, this is painful
//                    if (i >= InventoryMenu.ARMOR_SLOT_START && i < InventoryMenu.ARMOR_SLOT_END) {
//                        extension.lt$setVisualX(k + 10000f);
//                    } else if (i >= InventoryMenu.CRAFT_SLOT_START && i < InventoryMenu.ARMOR_SLOT_END) {
//                        extension.lt$setVisualX(k + slot.x * 21.1559f/16f - 76.9f);
//                        extension.lt$setVisualY(k + slot.y * 21.1559f/16f + 115.9f);
//                        extension.lt$setSize(21);
//                    } else if (i == InventoryMenu.SHIELD_SLOT) {
//                        extension.lt$setVisualX(k + 10000f);
//                    } else if (InventoryMenu.INV_SLOT_START <= i) {
//                        extension.lt$setVisualX(k + slot.x * 14.22f/16f + 169.5f);
//                        extension.lt$setVisualY(k + slot.y * 14.22f/16f + 55.3f + (InventoryMenu.isHotbarSlot(i) ? 4.5f : 0f));
