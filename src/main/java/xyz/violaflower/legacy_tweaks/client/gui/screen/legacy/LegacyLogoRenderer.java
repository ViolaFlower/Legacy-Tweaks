...
public class LegacyLogoRenderer {
    ...
    public void renderLogo(GuiGraphics guiGraphics, int screenWidth, float transparency, int height) {
        ...
        guiGraphics.blit(this.showEasterEgg ? EASTER_EGG_LOGO : MINECRAFT_LOGO, i, height, 0.0F, 0.0F, getLogoWidth(), getLogoHeight(), getLogoWidth(), getLogoTextureHeight());
        int j = screenWidth / 2 - getLogoTextureHeight();
        int k = height + getEditionHeightPos();
        guiGraphics.blit(MINECRAFT_EDITION, j, k, 0.0F, 0.0F, getEditionWidth(), getEditionHeight(), getEditionWidth(), getEditionTextureHeight());
