...
/// @deprecated
@Deprecated
public class OldLegacyInventoryScreen extends LegacyEffectRenderingInventoryScreen<LegacyInventoryMenu> implements RecipeUpdateListener {
    ...
    public OldLegacyInventoryScreen(Player player) {
