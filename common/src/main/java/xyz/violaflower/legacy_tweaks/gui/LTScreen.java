...
public class LTScreen extends Screen {
    ...
    public void render(DrawContext context, int mouseX, int mouseY, float delta) {
        ...
        managerInstance.tweaks.forEach((id, tweak) -> {
            context.drawCenteredTextWithShadow(textRenderer, Text.literal(tweak.getTweakID() + " - " + tweak.getTweakAuthor()), width / 2, height / 2 - i.get(), 0xffffff);
            ...
            }).dimensions(width / 2, height / 2 - (i.get()), 200, 20).build());
